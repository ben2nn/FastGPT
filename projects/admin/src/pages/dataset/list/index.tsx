...
const Dataset = () => {
  ...
  return (
    <ProtectedRoute>
      <Layout title={t('common:navbar.Datasets')}>
        <MyBox
                                      ...
                                      ? [
                                          {
                                            ...
                                            onClick: () =>
                                              onSelectDatasetType(DatasetTypeEnum.feishu)
                                          }
                                        ]
                                      : []),
                                      ...
                                      ? [
                                          {
                                            ...
                                            onClick: () =>
                                              onSelectDatasetType(DatasetTypeEnum.yuque)
                                          }
                                        ]
                                      : [])
                                  ]
              ...
              <Box ml="6" h={'100%'} pb={4} overflow={'auto'}>
                <FolderSlideCard
                  ...
                  managePer={{
                    ...
                    onGetCollaboratorList: () => getCollaboratorList(folderDetail._id) as any,
...
export async function getServerSideProps(context: any) {
  return {
    props: {
      ...(await serviceSideProps(context, ['dataset', 'user']))
    }
  };
}
