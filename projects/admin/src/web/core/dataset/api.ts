...
export const postDatasetSync = (data: PostDatasetSyncParams) =>
  POST(`/proapi/extend/dataset/datasetSync`, data, {
    timeout: 600000
  }).catch();
...
export const postChangeOwner = (data: { ownerId: string; datasetId: string }) =>
  POST(`/proapi/extend/dataset/changeOwner`, data);
...
export const postBackupDatasetCollection = ({
  ...
  formData.append('data', JSON.stringify({ datasetId, parentId }));
...
export const postCreateDatasetExternalFileCollection = (
  ...
  POST<{ collectionId: string }>(`/proapi/extend/dataset/collection/create/externalFileUrl`, data, {
    timeout: 360000
  });
...
export const getCollectionSource = (data: readCollectionSourceBody) =>
  POST<readCollectionSourceResponse>('/extend/dataset/collection/read', data);
