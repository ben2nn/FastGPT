...
description: Guides Codex in creating well-structured SKILL.md files following best practices. Provides clear guidelines for naming, structure, and content organization to make skills easy to discover and execute.
---

# Codex Agent Skill 编写规范
...
```bash
mkdir -p .Codex/skill/your-skill-name
cd .Codex/skill/your-skill-name
```
...
- [Codex Agent Skills 官方文档](https://docs.Codex.com/en/docs/agents-and-tools/agent-skills)
- [Best Practices Checklist](https://docs.Codex.com/en/docs/agents-and-tools/agent-skills/best-practices)
